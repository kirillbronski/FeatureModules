package com.kbcoding.features.cart.presentation.cartlist
...
import com.kbcoding.features.cart.databinding.ItemCartProductBinding
import com.kbcoding.features.cart.presentation.cartlist.entities.UiCartItem
...
private fun ImageView.setEnabledAndTint(isEnabled: Boolean) {
    ...
    if (isEnabled) {
        this.setTintColor(com.kbcoding.theme.R.color.action)
    } else {
        this.setTintColor(com.kbcoding.theme.R.color.action_disabled)
    }
}